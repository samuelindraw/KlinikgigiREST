        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prosentase = table.Column<double>(nullable: false),
                    Email = table.Column<string>(nullable: true),
                    TenantID = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdBarang = table.Column<int>(nullable: false),
                    Qty = table.Column<short>(nullable: false),
                    HargaSatuan = table.Column<int>(nullable: false),
                    TenantID = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiayaDasar = table.Column<int>(nullable: false),
                    BiayaKelipatan = table.Column<int>(nullable: false),
