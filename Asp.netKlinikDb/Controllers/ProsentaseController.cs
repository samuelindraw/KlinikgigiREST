...
namespace Asp.netKlinikDb.Controllers
{
    ...
    public class ProsentaseController : ControllerBase
    {
        ...
        //GET PROSENTASE BY USER DAN TENANT ID UNTUK DI TAMPILKAN DI BAGIAN TINDAKAN.......
        ...
        [HttpGet("{id}")]
        [Authorize(Roles = "Admin")]
        public async Task<Prosentase> Get(int id)
        {
            var model = await _Prosentase.GetById(id);
            return model;
        }
        // GET: api/Barang
